...
public class ProjetoGuru1 {
    ...
    public static void main(String[] args) {
        String nome, sexo, dataStr, signo, corSorte;
        ...
        dataStr = JOptionPane.showInputDialog(null, "Digite sua data de nascimento (dd/mm/aaaa):");
        ...
        sexo = JOptionPane.showInputDialog(null, "Digite seu sexo (1) para (Feminino) e (2) para (Masculino):");
        ...
        if (cor == 1) {
            ...
            if (ano >= 1970 && ano <= 2023) {
                if (sexo.equals("2 == masculino")) {
                    JOptionPane.showMessageDialog(null, "Sr." + nome + ", nascido no dia " + dia + "-" + mes + "-" + ano + " é do signo de " + signo + " - você tem " + idade + " anos - seu nº da sorte é " + numero + " e sua cor: " + corSorte);
                } else if (sexo.equals("1 == feminino")) {
                    JOptionPane.showMessageDialog(null, "Sra." + nome + ", nascida no dia " + dia + "-" + mes + "-" + ano + " é do signo de " + signo + " - você tem " + idade + " anos - seu nº da sorte é " + numero + " e sua cor: " + corSorte);
                }
